...
// Baseline is now pushed down (~-1.4) so the cylinder lives in the lower half
// of the viewport and the editorial poster has the upper half to itself.
let responsiveCylinderY = -1.4;
...
function onResize() {
  ...
  responsiveCylinderY = -1.4 - tallness * 0.5 - bigness * 0.45;
